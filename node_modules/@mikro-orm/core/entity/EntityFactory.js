...
class EntityFactory {
    ...
    create(entityName, data, options = {}) {
        ...
        if (exists && (0, wrap_1.helper)(exists).__initialized && !options.refresh) {
            (0, wrap_1.helper)(exists).__processing = true;
            (0, wrap_1.helper)(exists).__initialized = options.initialized;
            this.mergeData(meta2, exists, data, options);
            (0, wrap_1.helper)(exists).__processing = false;
            return exists;
        }
        data = { ...data };
        const entity = exists ?? this.createEntity(data, meta2, options);
        (0, wrap_1.helper)(entity).__processing = true;
        (0, wrap_1.helper)(entity).__initialized = options.initialized;
        ...
        if (options.merge && (0, wrap_1.helper)(entity).hasPrimaryKey()) {
        ...
        (0, wrap_1.helper)(entity).__processing = false;
        return entity;
    }
