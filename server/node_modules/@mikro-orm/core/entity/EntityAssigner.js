...
class EntityAssigner {
    ...
    static assign(entity, data, options = {}) {
        ...
        Object.keys(data).forEach(prop => {
            ...
            if (props[prop] && Utils_1.Utils.isCollection(entity[prop]) && Array.isArray(value) && EntityAssigner.validateEM(em)) {
        ...
        const items = value.map((item, idx) => {
            if (options.updateNestedEntities && options.updateByPrimaryKey && Utils_1.Utils.isPlainObject(item)) {
                ...
                if (pk) {
                    ...
                    if ((0, wrap_1.helper)(ref).isInitialized()) {
            ...
            /* istanbul ignore next */
            if (options.updateNestedEntities && !options.updateByPrimaryKey && (0, wrap_1.helper)(collection[idx])?.isInitialized()) {
