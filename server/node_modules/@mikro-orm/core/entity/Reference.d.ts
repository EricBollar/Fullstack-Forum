import type { Populate, Cast, Constructor, Dictionary, EntityProperty, IsUnknown, Primary, PrimaryProperty, ConnectionType } from '../typings';
import type { LockMode } from '../enums';
export declare type IdentifiedReference<T, PK extends keyof T | unknown = PrimaryProperty<T>> = true extends IsUnknown<PK> ? Reference<T> : ({
