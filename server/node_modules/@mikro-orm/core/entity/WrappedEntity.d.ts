...
import type { ConnectionType, Dictionary, EntityData, EntityDictionary, EntityMetadata, Populate, PopulateOptions, Primary } from '../typings';
...
export declare class WrappedEntity<T extends object, PK extends keyof T> {
    ...
    get __platform(): import("../index").Platform;
