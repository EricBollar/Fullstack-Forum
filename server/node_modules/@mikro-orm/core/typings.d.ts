...
export declare type EntityClass<T> = Function & {
    prototype: T;
};
export declare type EntityClassGroup<T> = {
    entity: EntityClass<T>;
    schema: EntityMetadata<T> | EntitySchema<T>;
};
export declare type EntityName<T> = string | EntityClass<T> | EntitySchema<T, any>;
export declare type GetRepository<Entity extends {
    [k: PropertyKey]: any;
...
export declare type EntityDTOProp<T> = T extends Scalar ? T : T extends LoadedReference<infer U> ? EntityDTO<U> : T extends Reference<infer U> ? Primary<U> : T extends {
...
declare type Loadable<T extends object> = Collection<T, any> | Reference<T> | readonly T[];
...
declare type LoadedLoadable<T, E extends object> = T extends Collection<any, any> ? T & LoadedCollection<E> : (T extends Reference<any> ? T & LoadedReference<E> : T & E);
...
export declare type New<T, P extends string = string> = Loaded<T, P>;
