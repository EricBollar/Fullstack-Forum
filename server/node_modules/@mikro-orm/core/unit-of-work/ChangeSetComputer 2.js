...
class ChangeSetComputer {
    ...
    computeChangeSet(entity) {
        ...
        const type = (0, entity_1.helper)(entity).__originalEntityData ? ChangeSet_1.ChangeSetType.UPDATE : ChangeSet_1.ChangeSetType.CREATE;
        const map = new Map();
        ...
        changeSet.originalEntity = (0, entity_1.helper)(entity).__originalEntityData;
