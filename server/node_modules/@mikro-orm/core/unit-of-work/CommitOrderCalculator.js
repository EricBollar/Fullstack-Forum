...
class CommitOrderCalculator {
    ...
    discoverProperty(prop, entityName) {
        const toOneOwner = (prop.reference === enums_1.ReferenceType.ONE_TO_ONE && prop.owner) || prop.reference === enums_1.ReferenceType.MANY_TO_ONE;
        const toManyOwner = prop.reference === enums_1.ReferenceType.MANY_TO_MANY && prop.owner && !prop.pivotEntity;
