...
export declare function OneToOne<T, O>(entity?: OneToOneOptions<T, O> | string | ((e?: any) => EntityName<T>), mappedBy?: (string & keyof T) | ((e: T) => any), options?: Partial<OneToOneOptions<T, O>>): (target: Partial<any>, propertyName: string) => any;
